...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Plataforma interna do escritório: fluxo de caixa, DRE, processos, clientes e BI.",
      },
      { name: "author", content: "Dra. Yasmin Mazzetti" },
      { property: "og:title", content: "Sigjur" },
      {
      ...
      { name: "twitter:title", content: "Sigjur" },
      {
        name: "twitter:description",
        content: "Plataforma interna do escritório: fluxo de caixa, DRE, processos, clientes e BI.",
      },
      { property: "og:image", content: "/favicon.png?v=3" },
      { name: "twitter:image", content: "/favicon.png?v=3" },
    ],
    links: [
